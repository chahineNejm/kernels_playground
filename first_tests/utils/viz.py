...
def plot_series_grid(
    ...
    *examples* is a list of dicts with at least 'history' and 'future' keys
    (the format returned by ``data.build_examples``).
    """
    ...
    for i in range(rows * cols):
        ...
        ax.set_title(f"sample {ex.get('sample_idx', i)}", fontsize=9)
